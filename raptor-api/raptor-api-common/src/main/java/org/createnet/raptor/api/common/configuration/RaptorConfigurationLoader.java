 ...
 */
@Component
public class RaptorConfigurationLoader extends ConfigurationLoader {

    @Override
    public Configuration loadConfiguration(String name, Class<? extends Configuration> clazz) {
        return super.loadConfiguration(name, clazz); //To change body of generated methods, choose Tools | Templates.
    }
