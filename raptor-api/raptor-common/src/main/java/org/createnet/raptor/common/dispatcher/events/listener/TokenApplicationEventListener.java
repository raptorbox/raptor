 ...
 */
@Component
public class TokenApplicationEventListener implements ApplicationListener<TokenApplicationEvent> {
    ...
    public void onApplicationEvent(TokenApplicationEvent event) {
        ...
        dispatcher.notifyTokenEvent(OperationName.valueOf(ev.getParentEvent()), ev.getToken());
    }
}
