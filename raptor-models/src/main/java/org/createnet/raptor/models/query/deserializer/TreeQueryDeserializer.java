 ...
 */
public class TreeQueryDeserializer extends AbstractQueryDeserializer<TreeQuery> {

    @Override
    public TreeQuery deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        handleTextQuery("parentId", query.parentId, node);
